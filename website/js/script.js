(() => {
  ...
  --------------------------------------------------------- */
  const MUSCLES = {
    shoulders: { title: 'Плечи', text: 'Формируют объём верхней части тела и стабилизируют руки почти в любом жиме и тяге.', view: 'front', points: [[384, 210, 58], [128, 210, 58]] },
    chest:     { title: 'Грудь', text: 'Отвечает за силу жимов и визуально «раскрывает» силуэт корпуса.', view: 'front', points: [[256, 236, 92]] },
    abs:       { title: 'Пресс', text: 'Стабилизирует корпус, защищает поясницу и держит осанку под нагрузкой.', view: 'front', points: [[256, 344, 78]] },
    biceps:    { title: 'Бицепс', text: 'Сгибает руку в локте — работает в тягах, подтягиваниях и повседневных движениях.', view: 'front', points: [[392, 312, 52], [120, 312, 52]] },
    forearms:  { title: 'Предплечья', text: 'Отвечают за силу хвата — от штанги в зале до сумок из магазина.', view: 'front', points: [[418, 472, 46], [94, 472, 46]] },
    legs:      { title: 'Ноги', text: 'Самые крупные мышцы тела — база для силы и обмена веществ всего организма.', view: 'front', points: [[286, 632, 92], [226, 632, 92]] },
    back:      { title: 'Спина', text: 'Формирует правильную осанку и мощь в тягах — самая недооценённая группа мышц.', view: 'back', points: [[256, 270, 128] ] },
    triceps:   { title: 'Трицепс', text: 'Разгибает руку и включается почти в любом жиме — основной объём руки.', view: 'back', points: [[440, 288, 50], [72, 288, 50]] },
  };
